            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {Array.from({ length: ex.sets }, (_, setIdx) => {
                  const done = completedSets[ex.id]?.[setIdx] ?? false;
                  return (
                    <button
                      type="button"
        ...
        <div>
          ...
          <div className="bg-card border border-border rounded-2xl p-4">
            <div className="grid grid-cols-7 gap-1 mb-1">
              {(["M-0", "T-1", "W-2", "T-3", "F-4", "S-5", "S-6"] as const).map(
                (dayKey) => (
                  <div
                    key={dayKey}
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <Input
                        ...
                        maxLength={100}
                        onChange={(e) =>
                          setDayForm({ name: e.target.value.slice(0, 100) })
                        }
